...
document.addEventListener('DOMContentLoaded', function() {
    ...
    prev.addEventListener('click', function() {
        if(i >= 1 && i <= image.length) {
            ...
            if (i == 0) {
                // Ken
                var mobileKen = document.querySelector('.mobileKen');

                mobileKen.style.opacity = '0';
                mobileKen.style.transition = 'all 1s';

                // Ryu
                var mobileRyu = document.querySelector('.mobileRyu');
                var fighter = document.querySelector('.fighter__item:nth-child(3)');

                mobileRyu.style.opacity = '1';
                mobileRyu.style.transition = 'all 1s';
                mobileRyu.style.position = 'absolute';
                mobileRyu.style.top = '147px';
                mobileRyu.style.width = '87%';
                fighter.style.left = '55%';
                fighter.style.top = '-17%';
                fighter.style.width = '150%';
            }
            ...
            if (i == 1) {
                ...
                mobileKen.style.opacity = '1';
                mobileKen.style.transition = 'all 1s';
                mobileKen.style.position = 'absolute';
                mobileKen.style.top = '147px';
                mobileKen.style.width = '87%';
                fighter.style.left = '50%';
                fighter.style.top = '-9%';
            ...
            return setImg(), prevButton(items);
        }
    });
